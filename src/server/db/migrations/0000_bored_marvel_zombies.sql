...
CREATE TABLE "jas_privacy_content" (
...
ALTER TABLE "jas_privacy_content" ADD CONSTRAINT "jas_privacy_content_created_by_id_jas_user_id_fk" FOREIGN KEY ("created_by_id") REFERENCES "public"."jas_user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
