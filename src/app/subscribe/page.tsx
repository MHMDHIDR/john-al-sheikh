    ...
    <main className="relative select-none flex min-h-screen flex-col items-center justify-center bg-white p-4 overflow-hidden">
      ...
      <div className="z-10 flex flex-col items-center justify-center max-w-5xl w-full mx-auto text-center gap-8">
        <div className="flex flex-col items-center space-y-6 min-w-full">
          <Logo className="animate-in fade-in duration-700 size-20" />
          ...
          <div className="flex flex-col items-center space-y-2">
            <h1 className="text-4xl sm:text-5xl md:text-5xl font-bold tracking-tight text-gray-900 animate-in fade-in slide-in-from-bottom-4 duration-700">
              <span className="block">جون آل-شيخ</span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-700 max-w-md mt-2 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
              .احصل على الدرجة التي ترغب بها في امتحان الايلتس
            </p>
          </div>
        </div>
